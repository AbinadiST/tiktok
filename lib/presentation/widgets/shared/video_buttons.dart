...
// instalamos el paquete ANIMATE_DO para hacer girar un ícono
...
class _CustomIconButton extends StatelessWidget {
  ...
  //cuando el WIDGET es privado normalmente el KEY en el constructor lo quitamos
  const _CustomIconButton({
    required this.value, 
    required this.iconData, 
    iconColor
    }): color = iconColor ?? Colors.white;
    //EL color que estamos recibiendo será = a ICONCOLOR, y si no se recibe será WHITE
